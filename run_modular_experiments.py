...
def main() -> None:
    ...
    print(f"Fusion: modular uniform average ({METHOD_PREFIX}* methods in CSV)")

    rows = run_modular_experiments(datasets, seeds, methods, topgen_kwargs, clf_kwargs, output)
